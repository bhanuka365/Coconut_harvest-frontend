...
const Register = () => {
  ...
  <div className="w-full relative">
    ...
    <span className={`absolute left-0 top-full text-red-400 text-xs ${usernameError ? "invisible" : "visible"}`}>
  ...
  <div className="w-full relative">
    ...
    <span className={`absolute left-0 top-full text-red-400 text-xs ${fnameError ? "invisible" : "visible"}`}>
  ...
  <div className="w-full relative">
    ...
    <span className={`absolute left-0 top-full text-red-400 text-xs ${lnameError ? "invisible" : "visible"}`}>
      cannot be empty or must contain only letters
    </span>
  </div>
  ...
  <div className="w-full relative">
    ...
    <span className={`absolute left-0 top-full text-red-400 text-xs ${phoneNumberError ? "invisible" : "visible"}`}>
  ...
  <div className="w-full relative">
    ...
    <span className={`absolute left-0 top-full text-red-400 text-xs ${addressError ? "invisible" : "visible"}`}>
      cannot be empty
    </span>
  </div>
  ...
  <div className="w-full relative">
    ...
    <span className={`absolute left-0 top-full text-red-400 text-xs ${descriptionError ? "invisible" : "visible"}`}>
      cannot be empty
    </span>
  </div>
  ...
  <div className="w-full relative">
    ...
    <div className="flex gap-2 items-center bg-white p-2 rounded-sm text-gray-900">
      ...
      />
      {textVisual1 ? (
        <FiEye className="cursor-pointer" onClick={() => setTextVisual1(false)} />
      ) : (
        <FiEyeOff className="cursor-pointer" onClick={() => setTextVisual1(true)} />
      )}
    </div>
    <span className={`absolute left-0 top-full text-red-400 text-xs ${newpasswordError ? "invisible" : "visible"}`}>
  ...
  <div className="w-full relative">
    ...
    <div className="flex gap-2 items-center bg-white p-2 rounded-sm text-gray-900">
      ...
      />
      {textVisual2 ? (
        <FiEye className="cursor-pointer" onClick={() => setTextVisual2(false)} />
      ) : (
        <FiEyeOff className="cursor-pointer" onClick={() => setTextVisual2(true)} />
      )}
    </div>

    {matchPasswords ? (
      <span className={`absolute left-0 top-full text-red-400 text-xs ${confirmpasswordError ? "invisible" : "visible"}`}>
        password must be 8+ chars with letters & numbers
      </span>
    ) : (
